...
func (x *IsAdminRespose) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminRespose) ProtoMessage() {}

func (x *IsAdminRespose) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminRespose.ProtoReflect.Descriptor instead.
func (*IsAdminRespose) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{1}
}

func (x *IsAdminRespose) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x22, 0x2b, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x65, 0x42, 0x14, 0x5a, 0x12,
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*IsAdminRespose)(nil),   // 1: auth.IsAdminRespose
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	1, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdminRespose
