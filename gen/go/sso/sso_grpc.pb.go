...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminRespose, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminRespose, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsAdminRespose)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminRequest) (*IsAdminRespose, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminRequest) (*IsAdminRespose, error) {
